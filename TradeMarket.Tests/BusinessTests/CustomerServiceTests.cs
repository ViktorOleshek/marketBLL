...
namespace TradeMarket.Tests.BusinessTests
{
    public class CustomerServiceTests
    {
        ...
        public async Task CustomerServiceUpdateAsyncThrowsMarketExceptionWithEmptySurname()
        {
            ...
            var customer = collection[collection.Count-1];
        ...
        public static ReadOnlyCollection<Person> GetTestPersonEntities =>
           new List<Person>()
           {
        ...
        public static ReadOnlyCollection<Customer> GetTestCustomerEntities =>
            new List<Customer>()
            {   
        ...
        public static ReadOnlyCollection<Receipt> GetTestReceiptsEntitiesWithReceiptDetails =>
             new List<Receipt>()
             {
                new Receipt
                {
