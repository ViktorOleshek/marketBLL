...
namespace TradeMarket.Tests.BusinessTests
{
    public class StatisticServiceTests
    {
        ...
        public async Task StatisticServiceGetMostPopularProductsReturnsMostPopularProductsOrderedBySalesCount(int productsCount)
        {
            ...
            var statisticService = new StatisticService(mockUnitOfWork.Object, UnitTestBusinessHelper.CreateMapperProfile());
            ...
            new List<ProductModel>()
{
        ...
        private static IEnumerable<ProductModel> ExpectedCustomersMostPopularProducts = 
            new List<ProductModel>()
            {
